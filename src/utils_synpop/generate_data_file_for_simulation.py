...
def generate_data_file_for_simulation(year):
    ...
    df_persons = add_information_about_households_from_synthetic_population(df_persons, year)
    df_persons = add_information_about_businesses_from_synthetic_population(df_persons, year)
...
def add_information_about_businesses_from_synthetic_population(df_persons, year):
    ''' Read the companies from the synthetic population '''
    if year == 2017:
        synpop_folder_path = Path('../data/input/SynPop/2017/')
        synpop_business_file_name = 'businesses.csv'
    elif year == 2030:
        synpop_folder_path = Path('../data/input/SynPop/2030/')
        synpop_business_file_name = 'businesses_overview_1_2030.csv'
    elif year == 2040:
        synpop_folder_path = Path('../data/input/SynPop/2040/')
        synpop_business_file_name = 'businesses_overview_1_2040.csv'
    elif year == 2050:
        synpop_folder_path = Path('../data/input/SynPop/2050/')
        synpop_business_file_name = 'businesses_overview_1_2050.csv'
    else:
        raise Exception('Reference year of the synthetic population not well defined for "businesses"')
    ...
    with open(synpop_folder_path / synpop_business_file_name, 'r') as businesses_file:
...
def add_information_about_households_from_synthetic_population(df_persons, year):
    ...
    if year == 2017:
        ...
        synpop_folder_path = Path('../data/input/SynPop/2030/')
        synpop_households_file_name = 'households_overview_1_2030.csv'
    elif year == 2040:
        synpop_folder_path = Path('../data/input/SynPop/2040/')
        synpop_households_file_name = 'households_overview_1_2040.csv'
    elif year == 2050:
        synpop_folder_path = Path('../data/input/SynPop/2050/')
        synpop_households_file_name = 'households_overview_1_2050.csv'
    else:
...
def get_persons_from_synthetic_population(year):
    ...
    if year == 2017:
        ...
        synpop_folder_path = Path('../data/input/SynPop/2040/')
        synpop_persons_file_name = 'persons_overview_1_2040.csv'
    elif year == 2050:
        synpop_folder_path = Path('../data/input/SynPop/2050/')
        synpop_persons_file_name = 'persons_overview_1_2050.csv'
    else:
        raise Exception('Reference year of the synthetic population not well defined for "persons"')
    ...
    # Transform the 'date of birth' variable to an 'age' variable (reference year: 2017 or 2050)
    df_persons['age'] = year - df_persons['dbirth'].str.split('-', expand=True)[2].astype(int)
